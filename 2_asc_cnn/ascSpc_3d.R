...
input_list_tr = list(STATUS_IN,FTS_PH_IN,PEDALITY_GRADE_IN,UPPER_DEPTH_IN,
                     ...
                     HOR_MASTER_IN,ELEM_TYPE_CODE_IN,PEDALITY_TYPE_IN,OBS_LITH_CODE_IN,
                     REL_MOD_SLOPE_CLASS_IN,VEG_SPEC_CODE_IN,SPCHOR_MASTER_IN,MOTT_TYPE_IN,
                     OCF_LITH_CODE_IN,COLOUR_CLASS_IN,ASC_TAG,SO_TAG,GG_TAG,SPC_TAG)
output_tag_tr = list(ASC_OUT,SO_OUT,GG_OUT,SG_OUT,SPC_OUT)
...
list_tr_data = list(STATUS_TR,FTS_PH_TR,PEDALITY_GRADE_TR,UPPER_DEPTH_TR,
                    ...
                    HOR_MASTER_TR,ELEM_TYPE_CODE_TR,PEDALITY_TYPE_TR,OBS_LITH_CODE_TR,
                    REL_MOD_SLOPE_CLASS_TR,VEG_SPEC_CODE_TR,SPCHOR_MASTER_TR,MOTT_TYPE_TR,
                    OCF_LITH_CODE_TR,COLOUR_CLASS_TR,asc_tag_tr,so_tag_tr,gg_tag_tr,spc_tag_tr)
list_tr_tag_data = list(asc_tag_tr,so_tag_tr,gg_tag_tr,sg_tag_tr,spc_tag_tr)
history = model %>% fit(list_tr_data,list_tr_tag_data,
                        epochs = 40, batch_size =256,validation_split =0.15)#,callbacks=callbacks)
...
list_test_data = list(STATUS_TEST,FTS_PH_TEST,PEDALITY_GRADE_TEST,UPPER_DEPTH_TEST,
                    ...
                    HOR_MASTER_TEST,ELEM_TYPE_CODE_TEST,PEDALITY_TYPE_TEST,OBS_LITH_CODE_TEST,
                    REL_MOD_SLOPE_CLASS_TEST,VEG_SPEC_CODE_TEST,SPCHOR_MASTER_TEST,MOTT_TYPE_TEST,
                    OCF_LITH_CODE_TEST,COLOUR_CLASS_TEST,asc_tag_test,so_tag_test,gg_tag_test,spc_tag_test)
list_test_tag_data = list(asc_tag_test,so_tag_test,gg_tag_test,sg_tag_test,spc_tag_test)
